...
//   Map<String, dynamic> person = {'name': 'Дмитрий', 'age': 17};
//   print(person['name']);
//   person['city'] = 'Волжский';

//   Set<int> ids = {1, 2, 3, 4, 5, 1};
//   print(ids);
//   print(ids.length);
...
//   describePet(name: 'Бобик', species: 'Пёс');

// print(repeat('ха'));
// print(repeat('ха', 3));

// List<int> numbers = [3, 2, 1, 4, 1, 5 , 9];
// numbers.sort((a, b) => b - a);
// print(numbers);

// List<String> names = ['Владимир', 'Иосиф', 'Феликс'];

// List<String> upper = names.map((names) => name.toUpperCase()).toList();
// print(upper);
...
// List<String> fruits3 = ['apple', 'banana', 'pineapple'];
...
void main() {
  Map<String, List<int>> students = {
    'Владимир Ленин': [5, 5, 5, 5, 5, 5],
    'Иосиф Сталин': [5, 4, 5, 3, 4, 5],
    'Феликс Дзержинский': [5, 4, 4, 4, 5, 5],
  };
